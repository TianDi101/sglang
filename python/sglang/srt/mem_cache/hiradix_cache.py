...
class HiRadixCache(RadixCache):
    ...
    def _report_transfer_bandwidth(
        self, start_event, finish_event, num_tokens: int, is_eviction: bool
    ) -> None:
        ...
        # start_loading() in cache_controller.py.
        ...
        gb_per_s = (num_tokens * bytes_per_token / 1e9) / (elapsed_ms / 1000.0)
        if is_eviction:
        ...
        if write_back:
            ...
            while len(self.ongoing_write_through) > 0:
                for (
                    ...
                    self._report_transfer_bandwidth(
                        start_event, finish_event, num_tokens, is_eviction=True
                    )
    ...
    def loading_check(self):
        ...
        while finish_count > 0:
            ...
            finish_event.synchronize()
            self._report_transfer_bandwidth(
                start_event, finish_event, num_tokens, is_eviction=False
            )
            for ack_id in ack_list:
